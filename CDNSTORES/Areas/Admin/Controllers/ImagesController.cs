...
namespace CDNSTORES.Areas.Admin.Controllers
{
    public class ImagesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Picture1,Picture2,Picture3,Picture4,Picture5,Picture6,Picture7")] Images images)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Picture1,Picture2,Picture3,Picture4,Picture5,Picture6,Picture7")] Images images)
        {
            if (ModelState.IsValid)
            {
